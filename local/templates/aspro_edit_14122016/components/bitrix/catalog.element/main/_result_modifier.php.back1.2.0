...
if (intVal($arParams["IBLOCK_STOCK_ID"])){
	...
	$dbRes = CIBlockElement::GetList(array(), array("ACTIVE" => "Y", "GLOBAL_ACTIVE" => "Y", "ACTIVE_DATE" => "Y", "IBLOCK_ID" => $arParams["IBLOCK_STOCK_ID"], "PROPERTY_LINK" => $arResult["ID"]), false, false, $arSelect);
...
if( !empty($arResult["PROPERTIES"]["SERVICES"]["VALUE"]) ){
	$arSelect = array("ID", "IBLOCK_ID", "IBLOCK_SECTION_ID", "NAME", "PREVIEW_PICTURE", "PREVIEW_TEXT", "DETAIL_PAGE_URL");
	$dbRes = CIBlockElement::GetList( array(), array("ACTIVE" => "Y", "GLOBAL_ACTIVE" => "Y", "ACTIVE_DATE" => "Y", "IBLOCK_ID" => $arResult["PROPERTIES"]["SERVICES"]["LINK_IBLOCK_ID"], "ID" => $arResult["PROPERTIES"]["SERVICES"]["VALUE"] ), false, false, $arSelect);
	while ($res = $dbRes->GetNext()){
