...
if(($arResult["PROPERTIES"]["CML2_MANUFACTURER"]) && ($arResult["PROPERTIES"]["CML2_MANUFACTURER"]["VALUE"] !=''))
{
	$arSelect = Array();
	$arFilter = Array("IBLOCK_ID"=>$arResult["PROPERTIES"]["CML2_MANUFACTURER"]["LINK_IBLOCK_ID"],"NAME"=>$arResult["PROPERTIES"]["CML2_MANUFACTURER"]["VALUE"]);
