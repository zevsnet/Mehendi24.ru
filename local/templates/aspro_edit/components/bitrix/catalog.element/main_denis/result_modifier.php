...
if(intVal($arParams["IBLOCK_STOCK_ID"]))
{
    ...
    $arResult["STOCK"] = CMshopCache::CIBLockElement_GetList(array('CACHE' => array("TAG" => CMshopCache::GetIBlockCacheTag($arParams["IBLOCK_STOCK_ID"]))), array(
...
if(!empty($arResult["PROPERTIES"]["SERVICES"]["VALUE"]))
{
    ...
    $arResult["SERVICES"] = CMshopCache::CIBLockElement_GetList(array('CACHE' => array("TAG" => CMshopCache::GetIBlockCacheTag($arResult["PROPERTIES"]["SERVICES"]["LINK_IBLOCK_ID"]))), array(
...
{
    $arBrand = CMshopCache::CIBLockElement_GetList(array(
        'CACHE' => array(
            "MULTI" => "N",
            "TAG"   => CMshopCache::GetIBlockCacheTag($arResult["PROPERTIES"]["BRAND"]["LINK_IBLOCK_ID"])
        )
    ), array(
...
\SB\PseudoSku::getSku($arResult, $arParams['IBLOCK_ID'], $arParams['DISPLAY_TYPE'], $arParams);
$arResult = $arResult[0];
?>