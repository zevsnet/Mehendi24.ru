...
?><? if ($arParams['SHOW_MINIMIZED'] == "Y")
{
	...
	<div class="reviews-collapse reviews-minimized" style='position:relative; float:none;'>
		<span class="reviews-collapse-link button wicon" id="sw<?=$arParams["FORM_ID"]?>" onclick1="window.UC.f<?=$arParams["FORM_ID"]?>.transverse()"><i></i><span><?=$arParams['MINIMIZED_EXPAND_TEXT']?></span></span>
	</div>
	<?
}
?>
