...
if($arResult["VARIABLES"]["SECTION_ID"] > 0)
{
    ...
    ), array('GLOBAL_ACTIVE' => 'Y', "ID" => $arResult["VARIABLES"]["SECTION_ID"]), false, array("ID"));
}
elseif(strlen(trim($arResult["VARIABLES"]["SECTION_CODE"])) > 0)
{
    ...
    ), array('GLOBAL_ACTIVE' => 'Y', "=CODE" => $arResult["VARIABLES"]["SECTION_CODE"]), false, array("ID"));
}
if(!$section["ID"])
{
    if($arResult["VARIABLES"]["ELEMENT_ID"] > 0)
    {
        $arElement = CCache::CIBLockElement_GetList(array(
            'CACHE' => array(
                "MULTI" => "N",
                "TAG"   => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])
            )
        ...
        if($arElement["IBLOCK_SECTION_ID"] && !$section)
        {
            ...
            ), array('GLOBAL_ACTIVE' => 'Y', "ID" => $arElement["IBLOCK_SECTION_ID"]), false, array("ID"));
        }
    }
...
<div class="catalog_detail">
    ...
    <? $ElementID = $APPLICATION->IncludeComponent("bitrix:catalog.element", "main_new", $arPropCtalogElement, $component); ?>
...
/*similar goods*/
$arExpValues = CCache::CIBlockElement_GetProperty($arParams["IBLOCK_ID"], $ElementID, array("CACHE" => array("TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), array("CODE" => "EXPANDABLES"));
if($arExpValues)
{
    $arAllValues["EXPANDABLES"] = $arExpValues;
}
/*accessories goods*/
$arAccessories = CCache::CIBlockElement_GetProperty($arParams["IBLOCK_ID"], $ElementID, array("CACHE" => array("TAG" => CCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), array("CODE" => "ASSOCIATED"));
if($arAccessories)
{
...
<div class="detail_footer">
    ...
    if($arViewedIDs)
    {
        ...
        <div class="similar_products_wrapp">
            ...
            <? $APPLICATION->IncludeComponent("bitrix:catalog.top", "products_slider_viewed", array(
