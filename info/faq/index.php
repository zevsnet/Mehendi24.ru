...
$APPLICATION->SetPageProperty("description", "Выможете задать любой интересующий вас вопрос");
$APPLICATION->SetPageProperty("keywords", "вопрос, помощь, гель лак, маникюр, педикюр");
$APPLICATION->SetPageProperty("title", "Вопрос-ответ - Мастера красоты Mehendi24.ru");
